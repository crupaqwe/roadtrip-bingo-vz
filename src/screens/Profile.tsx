  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.description}>
        RoadTrip Bingo is an interactive mobile app created by Jānis Dombrovskis, 
        designed to bring an extra layer of fun to road trips. Users can create or 
        join lobbies, participate in road trip-specific bingo games, and share 
        their experiences with friends. Whether you're spotting landmarks or 
        discovering local hidden gems, this app makes every journey an adventure.
      </Text>
